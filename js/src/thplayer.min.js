  ...
  $.fn.extend({
    "thplayer": function (options) {
      ...
      function thplayer_init() {
        document.getElementById("Thplayer").innerHTML = "" + '<div id="player-demo">' + '   <img id="player-album" src="http://p4.music.126.net/gYwk-n_UWAtOfDZBEV04dQ==/7699879929738059.jpg">' + '   <div id="player-mask"></div>' + '   <div id="play" class="bg play-bg" data-action="play"></div>' + '   <div id="pause" class="bg pause-bg" data-action="pause"></div>' + '   <div id="player-info">' + '       <strong class="title"></strong>' + '       <span class="and">-</span> ' + '       <span class="author"></span>' + "   </div>" + '   <div id="player-control">' + '       <span class="left-time">0:00</span>' + '       <span class="and">/</span> ' + '       <span class="right-time">3:45</span>' + "   </div>" + '   <div class="player-listbox">' + '       <div style="width:100%;text-align:center;position:relative">' + '           <input type="text" id="txtSong" placeholder="信仰  张信哲"> ' + '           <img src="/images/search.png" id="btnSearch">' + "       </div>" + '       <table class="th-list-table">' + '           <thead style="display:block;height:30px">' + '               <tr style="display:block;padding:0 20px;color:#999">' + '                   <th style="padding-right:160px">歌名</th>' + "                   <th>歌手</th>" + "               </tr>" + "           </thead>" + '           <tbody id="UserList" style="display:block;height:280px;width:330px;overflow:auto;margin-top:10px">' + "           </tbody>" + '           <tr id="LoadMore" style="display:none;cursor:pointer;text-align:center;font-size:10px;color:#565454" offset="0" search="0">' + '               <td colspan="8"></td>' + "           </tr>" + "       </table>" + "   </div>" + '   <div id="player-list-icon"></div>' + '   <div id="player-process">' + '   <div id="player-current"></div>' + "       <span></span>" + "   </div>" + "</div>" + '<div id="player-flex">' + '   <span id="player-show"></span>' + "</div>" + '<audio id="thaudio" loop></audio>';
        var myaudio = document.getElementById("thaudio");
